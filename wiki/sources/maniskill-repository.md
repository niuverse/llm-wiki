...
这是 [[robotics-simulation-infrastructure|ManiSkill]] 官方代码仓库 README 快照。README 把 ManiSkill 3 定位为 powered 由 SAPIEN 的开源机器人仿真与训练框架，重点是操作技能、GPU-并行化的仿真/渲染、异构并行场景、real2sim / sim2real 示例和 tuned 学习基线。
